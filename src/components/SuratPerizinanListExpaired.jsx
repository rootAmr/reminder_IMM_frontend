...
const SuratIzinListExpaired = () => {
  ...
  new Date(item.tanggal_berakhir) < currentDate &&
  ...
  return (
    ...
    <div style= {containerStyle}>
      <h1 className="title">Expired Report & Payment Obligation</h1>
        ...
        <tbody>
          {currentItems.map((item, index) => (
            <tr key={item.uuid}>
              ...
              <td style={{ color: new Date(item.tanggal_berakhir) < currentDate ? "red" : "inherit" }}>
...
export default SuratIzinListExpaired;
